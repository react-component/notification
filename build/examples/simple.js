...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".rc-notification {\n  z-index: 99999;\n  width: 200px;\n}\n.rc-notification .rc-notice {\n  background-color: #1F8DD6;\n  color: #fff;\n  border-radius: 2px;\n  width: 100%;\n  text-align: center;\n  margin: 0 auto 10px auto;\n}\n.rc-notification .rc-notice.rc-notice-info {\n  padding: 10px;\n  background-color: #1F8DD6;\n}\n.rc-notification .rc-notice.rc-notice-success {\n  padding: 10px;\n  background-color: #50CD84;\n}\n.rc-notification .rc-notice.rc-notice-warning {\n  padding: 10px;\n  background-color: #FF8859;\n}\n.rc-notification .rc-notice.rc-notice-error {\n  padding: 10px;\n  background-color: #FF5F5F;\n}\n.rc-notification .rc-notice .rc-notice-buttons {\n  margin-top: 10px;\n  text-align: right;\n}\n.rc-notification .rc-notice .rc-notice-buttons button {\n  background: transparent;\n  color: #fff;\n}\n.rc-notification .rc-notice .rc-notice-buttons button.rc-notice-button-close {\n  border: 1px #fff solid;\n}\n.rc-notification .rc-notice .rc-notice-buttons button:hover {\n  opacity: .75;\n  cursor: pointer;\n}\n.rc-notice-anim-enter {\n  opacity: 0.01;\n  transition: opacity 1s ease-in;\n  -webkit-transition: opacity 1s ease-in;\n}\n.rc-notice-anim-enter.rc-notice-anim-enter-active {\n  opacity: 1;\n}\n.rc-notice-anim-leave {\n  opacity: 1;\n  transition: opacity 1s ease-in;\n  -webkit-transition: opacity 1s ease-in;\n}\n.rc-notice-anim-leave.rc-notice-anim-leave-active {\n  opacity: 0.01;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var domAlign = __webpack_require__(9);
	var clone = __webpack_require__(1);
	var CSSTransitionGroup = __webpack_require__(10);
	var instanceId = 0;
	  ...
	  render:function() {
	    ...
	    return (
	      React.createElement("div", {className: wrapperClass}, 
	        React.createElement("div", {className: "rc-notice-content"}, this.props.children), 
	        React.createElement("div", {className: "rc-notice-buttons"}, 
	          React.createElement("button", {className: "rc-notice-button-close", onClick: this.close}, "close")
	        )
	      )
	    );
	  }
	...
	var Notification = React.createClass({displayName: "Notification",
	  ...
	  render:function() {
	    var noticeNodes = this.state.notices ? this.state.notices.map(function(notice){
	      var onEnd = concatFns(this.remove.bind(this, notice.key), notice.options.onEnd);
	      return (React.createElement(Notice, React.__spread({},  notice.options, {onEnd: onEnd, key: notice.key}), notice.content));
	    }.bind(this)) : null;
	
	
	    return (
	      React.createElement("div", {className: "rc-notification"}, 
	        React.createElement(CSSTransitionGroup, {transitionName: "rc-notice-anim"}, noticeNodes)
	      )
	    );
	  }
	});
	...
	function notice( content, options, createNewInstance ) {
	  ...
	  if( !notificationInstances[id] ){
	    ...
	    notificationInstances[id] = React.render(React.createElement(Notification, React.__spread({},  opts)), div);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var noticeDom = (React.createElement("div", null, "this is a virtual dom content with link", React.createElement("a", {href: "http://github.com"}, "github.com")));
